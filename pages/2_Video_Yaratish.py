...
if not os.path.isdir(SFX_DIR) and add_sfx:
    st.warning(f"⚠️ `{SFX_DIR}/` papkasi topilmadi — SFX o'chirib qo'yiladi.")
    add_sfx = False
...
if st.button("🚀 Video Yaratish", type="primary"):
    ...
    if auto_upload:
        with st.spinner("YouTube'ga yuklanmoqda..."):
            ...
            st.success(f"✅ YouTube'ga yuklandi: [https://youtube.com/watch?v=](https://youtube.com/watch?v=){video_id}")
